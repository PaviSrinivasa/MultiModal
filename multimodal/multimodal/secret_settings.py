...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'mpimultimodalad*min',  # enter db password here
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
#AUTH_LDAP_SERVER_URI = 'ldap://nt01.mpi.nl:389'
#AUTH_LDAP_BIND_DN = 'CN=multimodal,CN=Users,DC=mpi,DC=nl'
#AUTH_LDAP_BIND_PASSWORD = '9n422pUv3'
